...
export const AIChatWidget = () => {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: "assistant",
      content: "👋 Hello! I'm your AI real estate assistant for Portuguese property investment. I can help you with:\n\n• Golden Visa program requirements\n• Property market insights\n• Investment strategies\n• Rental yield analysis\n\nHow can I assist you today?",
    },
  ]);
          ...
          <div className="flex items-center justify-between p-4 border-b bg-gradient-to-r from-primary to-primary/80 text-primary-foreground rounded-t-lg">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-xs opacity-90">Ask me anything about Portuguese properties</p>
              </div>
            </div>
            <Button
              variant="ghost"
          ...
          <div className="p-4 border-t">
            <div className="flex gap-2">
              <Input
                ...
                placeholder="Ask about Golden Visa, properties..."
                disabled={isLoading}
                className="flex-1"
              />
              <Button
