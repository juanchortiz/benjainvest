...
const MortgageFormInputs: React.FC<MortgageFormInputsProps> = ({ input, onInputChange }) => {
  ...
  return (
    <div className="space-y-6">
      {/* Datos del Inmueble */}
      <div>
        <h3 className="text-xl font-semibold text-foreground mb-4">{t('mortgage.propertyData')}</h3>
      ...
      <div>
        <h3 className="text-xl font-semibold text-foreground mb-4">{t('mortgage.loanConditions')}</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-2">
      ...
      <div>
        <h3 className="text-xl font-semibold text-foreground mb-4">{t('mortgage.feesAndInsurance')}</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-2">
      ...
      {/* Datos del Comprador */}
      <div>
        <h3 className="text-xl font-semibold text-foreground mb-4">{t('mortgage.buyerData')}</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-2">
