...
const StickyContactButton = () => {
  ...
  return (
    <Button
      ...
      className="fixed bottom-6 right-6 z-50 h-14 w-14 rounded-full shadow-floating bg-green-500 hover:bg-green-600 transition-all duration-300 hover:scale-110"
      size="icon"
    >
